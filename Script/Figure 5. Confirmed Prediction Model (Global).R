...
## Original Script Generated by: Andre Calero Valdez
## Script Modified by: Dong Hyun (Veo) Chae
## Data Source: John Hopkins University Dataset

## This script entails the data structure visualization 
## referenced as Figure 5 in the publication.
...
#User Defined Function to import PNG file
get_png <- function(filename) {
    grid::rasterGrob(png::readPNG(filename), interpolate = TRUE)
}

#User Defined function to create and draw text and plotmath expressions.
get_txt <- function(txt) {
    grid::textGrob(txt)
}

#User Defined function to create a plot that places the logos of the original creator
...
read_confirmed_cases <- function() {
    read_cached_file("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv",
                     "C:/Users/dchae2/Desktop/Confirmed Cases Prediction Model (Global)/Model/confirmed_updated.rds")
}
...
read_death_cases <- function() {
    read_cached_file("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv",
                     "C:/Users/dchae2/Desktop/Confirmed Cases Prediction Model (Global)/Model/deaths.rds")
}
